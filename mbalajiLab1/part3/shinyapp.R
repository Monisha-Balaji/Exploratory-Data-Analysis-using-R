...
twitter_data<-read.csv("totaltweets_processed")
hn_data<-read.csv("hn_processed")
flu_data<-read.csv("flu_processed")
...
server <- function(input, output) {
   ...
   output$heatmap <- renderPlotly({
     #data3 <- read.csv("C:/Users/Monisha Balaji/Downloads/part2/part2/StateDatabyWeekforMap_2018-19week40-8.csv", header=T)
